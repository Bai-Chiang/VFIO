virt-install \
    ...
    --os-variant name='fedora39' \
    --cdrom "/var/lib/libvirt/images/Nobara-39-Official-Nvidia-2023-12-24.iso" \
    ...
    --tpm default \
    --disk path="/var/lib/libvirt/images/nobara.qcow2",size=128,bus=virtio \
